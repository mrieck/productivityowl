...
var PlainDraggable = function () {
  ...
  _createClass(PlainDraggable, [{
    ...
    value: function remove() {
        //PRODUCTIVITY OWL CHANGE THAT TOOK HOURS TO FIGURE OUT
        //remove() SHOULD FORCE onDragEnd
        //HAD TO MIGRATE TO THIS COMPLICATED DnD LIBRARY FROM Yahoo DnD YUI 2.9
        //YUI HAD MINIFIED FILES WITH NO MAPS, AND FIREFOX ADD-ONS DON'T ALLOW THAT.  UGH
